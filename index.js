...
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/altenos/material-theme@master/css/mdui_v2.min.css" asyc>'
);
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/altenos/material-theme@master/css/css_v2.min.css" async>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/altenos/material-theme@master/js/mdui.min.js"></script async>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/altenos/material-theme@master/js/flv.min.js"></script async>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/altenos/material-theme@master/js/DPlayer.min.js"></script async>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/altenos/material-theme@master/js/markdown-it.min.js"></script async>'
);
document.write(
...
if (UI.theme == "material-dark") {
  document.write(
    `<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/altenos/material-theme@master/css/material-dark.min.css" async>
    <meta name="theme-color" content="#121212">`
  );
} else if (UI.theme == "dark") {
  document.write(
    `<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/altenos/material-theme@master/css/dark.min.css" async>
	...
	<div class="navSize">
        ...
        UI.disable_navicon == true ? "none" : "block"
				...
				<ul class="menu_ul">
					...
					<li class="menu_li"><a href="https://bucket.mr0gx.gq" target="_blank">Stream</a></li>
				</ul>
...
<div class="mdui-container">
	<div class="mdui-container-fluid">
		<div id="nav" class="mdui-toolbar material-item nav-style"> </div>
    </div>
	<div class="mdui-container-fluid">
		<div id="head_md" class="mdui-typo material-item" style="display:none;padding: 20px 0;"></div>
		<div id="content" class="material-item"></div>
	 	<div id="readme_md" class="mdui-typo material-item" style="display:none; padding: 20px 0;"></div>
	</div>
</div>
	`;
  $("body").html(html);
...
<script src="//cdn.jsdelivr.net/gh/altenos/material-theme/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/altenos/material-theme/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
